...
本文介绍Adobe Experience Manager Guidesas a Cloud Service2024.04.0版的升级说明和兼容性矩阵。

有关新增功能和增强功能的详细信息，请查看 [2024.04.0版本中的新增功能](whats-new-2024-04-0.md).

有关此版本中修复的问题列表，请查看 [修复了2024.04.0版本中的问题](fixed-issues-2024-04-0.md).

## 兼容性矩阵

本部分列出了2024.04.0版Experience Manager指南as a Cloud Service支持的软件应用程序的兼容性矩阵。
