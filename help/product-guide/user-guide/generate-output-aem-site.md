...
| 站点名称 | 将输出存储在AEM存储库中的网站名称。<br><br>将使用此处指定的名称创建AEM存储库中的节点。 如果未指定站点名称，则使用DITA映射文件名创建站点节点。<br><br>此处指定的站点名称还用作浏览器选项卡中的标题。<br><br>您还可以在设置站点名称时使用变量。 有关使用变量的更多详细信息，请参阅 [使用变量设置目标路径、站点名称或文件名选项](generate-output-use-variables.md#id18BUG70K05Z). |
