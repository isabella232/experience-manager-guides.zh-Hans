...
- 与4.1 AEM Guides的兼容性： [4.1兼容性矩阵](/help/product-guide/release-info/release-notes-4.1.md#compatibility-matrix)
...
- 最新版本： [最新版本信息](/help/product-guide/release-info/latest-release-info.md)
